...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed md:sticky top-16 left-0 w-60 sm:w-64 md:w-64 lg:w-72 bg-white/90 shadow-2xl backdrop-blur-xl border-r border-blue-100 transform
          ${isActive ? "translate-x-0" : "-translate-x-full"} md:translate-x-0
          transition-all duration-300 ease-in-out rounded-r-2xl flex flex-col z-30 h-[calc(100vh-4rem)]`}
      >
        {/* Links */}
