...
const AllOrders = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">All Orders</h2>
      ...
      <div className="overflow-x-auto shadow-md rounded-lg bg-white">
        <table className="min-w-full border border-gray-200 text-sm md:text-base">
          <thead className="bg-gray-100">
            <tr>
              <th className="border-b p-2 md:p-3 text-left text-gray-600">Order ID</th>
              <th className="border-b p-2 md:p-3 text-left text-gray-600">User</th>
              <th className="border-b p-2 md:p-3 text-left text-gray-600">Product</th>
              <th className="border-b p-2 md:p-3 text-left text-gray-600">Quantity</th>
              <th className="border-b p-2 md:p-3 text-left text-gray-600">Status</th>
              <th className="border-b p-2 md:p-3 text-left text-gray-600">Actions</th>
            </tr>
          </thead>
          <tbody className="bg-white divide-y divide-gray-200">
            {currentOrders.length > 0 ? (
              currentOrders.map((o) => (
                <tr key={o._id} className="hover:bg-gray-50 transition duration-200">
                  <td className="p-2 md:p-3 text-gray-700 font-medium">{o._id}</td>
